...
void setDefaultInstructions(Embase3Roues *e)
{
	...
	case(BLEU):
		e->appendWait(1000);
		e->appendRelativeMove(0, 1.556, 0);
		e->appendWait(1000);
		e->appendRelativeMove(0, 0, -40);
		e->appendWait(1000);
		e->appendRelativeMove(0, 1.228, 0);
		e->appendWait(10000);

	case(JAUNE):
		e->appendWait(1000);
		e->appendRelativeMove(0, -1.761, 0);
		e->appendWait(1000);
		e->appendRelativeMove(0, 0, 40);
		e->appendWait(1000);
		e->appendRelativeMove(0, -1.076, 0);
		e->appendWait(10000);
